  ...
  return (
    <div>
      ...
      <p>
        ...
        is collected, used, and disclosed by Shaman Enterprises.
        <h1>Privacy Policy</h1>
        <p>
          This Privacy Policy applies to our website, and its associated
          subdomains www.shamansilverstore.in alongside our application. By
        ...
        <p>
          ...
          to Shaman Enterprises, that is responsible for your information under
          this Privacy Policy.
        </p>
        -Country: where Shaman Enterprises or the owners/founders of Shaman
        Enterprises are based, in this case is India -Customer:¬†refers to the
        company, organization or person that signs up to use the products and
        services by Shaman Enterprises to manage the relationships with your
        consumers or service users. -Device:¬†any internet connected device such
        as a phone, tablet, computer or any other device that can be used to
        visit shamansilverstore.in and use the services. -IP address: Every
        ...
        -Personnel:¬†refers to those individuals who are employed by Shaman
        Enterprises or are under contract to perform a service on behalf of one
        ...
        identifiability of a natural person. -Service: refers to the service
        provided by Shaman Enterprises as described in the relative terms (if
        available) and on this platform. -Third-party service:¬†refers to
        ...
        may interest you. -Website: Shaman Enterprises .site, which can be
        accessed via this URL: www.shamansilverstore.in -You: a person or entity
        that is registered with Shaman Enterprises to use the Services.
        <br />
        ...
        <br />
        -Name / Username -Phone Numbers -Email Addresses
        <br />
        ...
        customer service requests and support needs) -To process transactions
        -To administer a contest, promotion, survey or other site feature -To
        send periodic emails
        <br />
        When does Shaman Enterprises (shamansilverstore.in) use end user
        information from third parties?
        <br />
        Shaman Enterprises (shamansilverstore.in) will collect End User Data
        necessary to provide the Shaman Enterprises (shamansilverstore.in)
        ...
        <br />
        When does Shaman Enterprises (shamansilverstore.in) use customer
        information from third parties?
        <br />
        ...
        in becoming a Shaman Enterprises (shamansilverstore.in) customer, we
        receive information from a third party that provides automated fraud
        detection services to Shaman Enterprises (shamansilverstore.in). We also
        ...
        perform these services for us and for you. ‚Wemay share portions of our
        ...
        whether you have visited the website in a shared location, and type of
        the device used to visit the website. They may aggregate information
        about our advertising and what you see on the website and then provide
        auditing, research and reporting for us and our advertisers.¬†‚Ä®‚Ä® We
        ...
        <br />
        Shaman Enterprises (shamansilverstore.in) will collect personal
        ...
        <br />
        We keep your information only so long as we need it to provide Shaman
        Enterprises (shamansilverstore.in) to you and fulfill the purposes
        ...
        keep it to comply with our legal or regulatory obligations, well either
        remove it from our systems or depersonalize it so that we cant identify
        you.
        <br />
        ...
        any information you transmit to (your company name) or guarantee that
        ...
        <br />
        Shaman Enterprises (shamansilverstore.in) is incorporated in India.
        ...
        information.
        <br />
        Is the information collected through the Shaman Enterprises
        (shamansilverstore.in) Service secure?
        <br />
        ...
        Shaman Enterprises (shamansilverstore.in) collects depend on your
        relationship with Shaman Enterprises (shamansilverstore.in). Personnel
        ...
        the assets of Shaman Enterprises (shamansilverstore.in) or any of its
        Corporate Affiliates (as defined herein), or that portion of Shaman
        Enterprises (shamansilverstore.in) or any of its Corporate Affiliates to
        ...
        Shaman Enterprises (shamansilverstore.in), whether by ownership or
        ...
        other local, state, national, or international laws. By using Shaman
        Enterprises (shamansilverstore.in) or contacting us directly, you
        ...
        those that have a link on our platform, is subject to that website‚Äôs
        ...
        acknowledge and agree that Shaman Enterprises (shamansilverstore.in)
        ...
        residents. Our customers‚Äô data is important irrespective of where they
        ...
        Personal data extends beyond a person‚Äôs name or email address. Some
        ...
        fulfil its purpose. -People covered by the GDPR have the right to access
        their own personal data. They can also request a copy of their data, and
        ...
        At Shaman Enterprises (shamansilverstore.in) we strongly believe that
        your data privacy is very important and we already have solid security
        and privacy practices in place that go beyond the requirements of this
        new regulation.
        <br />
        Individual Data Subject s Rights - Data Access, Portability and Deletion
        <br />
        We are committed to helping our customers meet the¬†data subject rights
        requirements of GDPR. Shaman Enterprises (shamansilverstore.in)
        ...
        working with EU customers, you need to be able to provide them with the
        ability to access, update, retrieve and remove personal data. We got
        you! We ve been set up as self service from the start and have always
        given you access to your data and your customers data. Our
        customer¬†support team is here for you to answer any questions you might
        ...
        <br />
        CalOPPA users have the following rights: -Right to Know and Access. You
        may submit a verifiable request for information regarding the: (1)
        ...
        collected about you. -Right to Equal Service. We will not discriminate
        against you if you exercise your privacy rights. -Right to Delete. You
        may submit a verifiable request to close your account and we will delete
        Personal Information about you that we have collected. -Right to request
        ...
        <br />
        Contact Us Don t hesitate to contact us if you have any questions. -Via
        Email: shamanenterprisesbangalore@gmail.com
      </p>
    </div>
  );
};
