...
const TermsConditions = () => {
  return (
    <div className="text-left justify-center">
      ...
      <h2 className="text-l text-center font-bold">General Terms</h2>
      <p>
        By accessing and placing an order with Shaman Enterprises
        (shamansilverstore.in), you confirm that you are in agreement with and
        bound by the terms of service contained in the Terms & Conditions
        outlined below. These terms apply to the entire website and any email or
        other type of communication between you and Shaman Enterprises
        (shamansilverstore.in).
      </p>
      <p>
        Under no circumstances shall Shaman Enterprises (shamansilverstore.in)
        ...
        profit, arising out of the use, or the inability to use, the materials
        on this site, even if Shaman Enterprises (shamansilverstore.in) team or
      ...
      <p>
        Shaman Enterprises (shamansilverstore.in) will not be responsible for
        any outcome that may occur during the course of usage of our resources.
        We reserve the rights to change prices and revise the resources usage
        policy in any moment.
      </p>
      <h2 className="text-l text-center font-bold">License</h2>
      <p>
        Shaman Enterprises (shamansilverstore.in) grants you a revocable,
      ...
      <h2 className="text-l text-center font-bold">Meanings</h2>
      <h4>For this Terms & Conditions:</h4>
      <p>
        ...
        Shaman Enterprises (shamansilverstore.in), that is responsible for your
        information under this Terms & Conditions.
        <br />
        -Country: where Shaman Enterprises (shamansilverstore.in) or the
        owners/founders of Shaman Enterprises (shamansilverstore.in) are based,
        in this case is India
        <br />
        -Device: any internet connected device such as a phone, tablet,
        computer or any other device that can be used to visit Shaman
        Enterprises (shamansilverstore.in) and use the services.
        <br />
        -Service: refers to the service provided by Shaman Enterprises
        ...
        <br />
        -Website: Shaman Enterprises .site, which can be accessed via this URL:
        www.shamansilverstore.in
        <br />
        -You: a person or entity that is registered with Shaman Enterprises
        (shamansilverstore.in) to use the Services.
        <br />
      </p>
      <h2 className="text-l text-center font-bold">Restrictions</h2>
      <p>
        ...
        of copyright or trademark) of Shaman Enterprises
        (shamansilverstore.in)or its affiliates, partners, suppliers or the
        licensors of the website.
        <br />
      </p>
      <h2 className="text-l text-center font-bold">Return and Refund Policy</h2>
      <p>
      ...
      <p>
        ...
        modify, publish, or redistribute the Suggestions for any purpose and in
      ...
      <h2 className="text-l text-center font-bold">Links to Other Websites</h2>
      <p>
        This Terms & Conditions applies only to the Services. The Services may
        contain links to other websites not operated or controlled by Shaman
        Enterprises (shamansilverstore.in). We are not responsible for the
      ...
      <p>
        ...
        features within the Service) to you or to users generally at (Shaman
        Enterprises (shamansilverstore.in)); sole discretion, without prior
        notice to you. You may stop using the Service at any time. You do not
        need to specifically inform (Shaman Enterprises (shamansilverstore.in));
        when you stop using the Service. You acknowledge and agree that if
        (Shaman Enterprises (shamansilverstore.in)); disables access to your
      ...
      <p>
        Shaman Enterprises (shamansilverstore.in) reserves the right to modify,
        suspend or discontinue, temporarily or permanently, the website or any
        service to which it connects, with or without notice and without
        liability to you.
      </p>
      <h2 className="text-l text-center font-bold">Updates to Our website</h2>
      <p>
      ...
      <h2 className="text-l text-center font-bold">Third-Party Services</h2>
      <p>
        ...
        legality, decency, quality or any other aspect thereof. Shaman
        Enterprises (shamansilverstore.in) does not assume and shall not have
      ...
      <p>
        This Agreement shall remain in effect until terminated by you or Shaman
        Enterprises (shamansilverstore.in). Shaman Enterprises
        (shamansilverstore.in) may, in its sole discretion, at any time and for
        ...
        Shaman Enterprises (shamansilverstore.in), in the event that you fail to
        comply with any provision of this Agreement. You may also terminate this
        Agreement by deleting the website and all copies thereof from your
        computer.
        <br />
      ...
      <h2 className="text-l text-center font-bold">Indemnification</h2>
      <p>
      ...
      <p>
        ...
        limitation to the foregoing, Shaman Enterprises (shamansilverstore.in)
        provides no warranty or undertaking, and makes no representation of any
        kind that the website will meet your requirements, achieve any intended
        ...
        (your company name) are free of viruses, scripts, trojan horses, worms,
      ...
      <h2 className="text-l text-center font-bold">Limitation of Liability</h2>
      <p>
        Notwithstanding any damages that you might incur, the entire liability
        of Shaman Enterprises (shamansilverstore.in) and any of its suppliers
        under any provision of this Agreement and your exclusive remedy for all
        of the foregoing shall be limited to the amount actually paid by you for
        the website.
        <br />
        To the maximum extent permitted by applicable law, in no event shall
        Shaman Enterprises (shamansilverstore.in) or its suppliers be liable for
        ...
        use of or inability to use the website, third-party software and/or
        third-party hardware used with the website, or otherwise in connection
        with any provision of this Agreement), even if Shaman Enterprises
        (shamansilverstore.in) or any supplier has been advised of the
      ...
      <h2 className="text-l text-center font-bold">Severability</h2>
      <p>
        ...
        notices published by Shaman Enterprises (shamansilverstore.in) on the
        Services, shall constitute the entire agreement between you and Shaman
        Enterprises (shamansilverstore.in) concerning the Services. If any
      ...
      <h2 className="text-l text-center font-bold">Waiver</h2>
      <p>
      ...
      <p>
        ...
        longer authorized to use Shaman Enterprises (shamansilverstore.in).
      </p>
      <h2 className="text-l text-center font-bold">Entire Agreement</h2>
      <p>
        The Agreement constitutes the entire agreement between you and Shaman
        Enterprises (shamansilverstore.in) regarding your use of the website and
      ...
      <h2 className="text-l text-center font-bold">Updates to Our Terms</h2>
      <p>
      ...
      <h2 className="text-l text-center font-bold">Intellectual Property</h2>
      <p>
        ...
        thereof), are owned by Shaman Enterprises (shamansilverstore.in), its
        licensors or other providers of such material and are protected by India
        ...
        Shaman Enterprises (shamansilverstore.in), unless and except as is
      ...
      <p>
        In the event of a dispute, you or Shaman Enterprises
        (shamansilverstore.in) must give the other a Notice of Dispute, which is
        a written statement that sets forth the name, address, and contact
        ...
        via email to: (shamanenterprisesbangalore@gmail.com). Shaman
        Enterprises (shamansilverstore.in) will send any Notice of Dispute to
        you by mail to your address if we have it, or otherwise to your email
        address. You and Shaman Enterprises (shamansilverstore.in) will attempt
        to resolve any dispute through informal negotiation within sixty (60)
        days from the date the Notice of Dispute is sent. After sixty (60) days,
        you or Shaman Enterprises (shamansilverstore.in) may commence
        arbitration.
      </p>
      ...
      <p>
        ...
        jury. The dispute shall be settled by binding arbitration in accordance
      ...
      <h2 className="text-l text-center font-bold">Submissions and Privacy</h2>
      <p>
        ...
        and will become the sole property of Shaman Enterprises
        (shamansilverstore.in) without any compensation or credit to you
        whatsoever. Shaman Enterprises (shamansilverstore.in) and its affiliates
        shall have no obligations with respect to such submissions or posts and
        may use the ideas contained in such submissions or posts for any
      ...
      <h2 className="text-l text-center font-bold">Promotions</h2>
      <p>
        Shaman Enterprises (shamansilverstore.in) may, from time to time,
        include contests, promotions, sweepstakes, or other activities
        (Promotions ) that require you to submit material or information
        concerning yourself. Please note that all Promotions may be governed by
        separate rules that may contain certain eligibility requirements, such
        as restrictions as to age and geographic location. You are responsible
        to read all Promotions rules to determine whether or not you are
        eligible to participate. If you enter any Promotion, you agree to abide
      ...
      <h2 className="text-l text-center font-bold">Typographical Errors</h2>
      <p>
      ...
      <h2 className="text-l text-center font-bold">Miscellaneous</h2>
      <p>
        ...
        of Shaman Enterprises (shamansilverstore.in). Shaman Enterprises
        (shamansilverstore.in) will be entitled to injunctive or other equitable
        relief (without the obligations of posting any bond or surety) in the
        event of any breach or anticipatory breach by you. Shaman Enterprises
        (shamansilverstore.in) operates and controls the Shaman Enterprises
        (shamansilverstore.in) Service from its offices in India. The Service is
        ...
        the Shaman Enterprises (shamansilverstore.in) Service from other
        locations do so on their own initiative and are solely responsible for
        compliance with local laws, if and to the extent local laws are
        applicable. These Terms & Conditions (which include and incorporate the
        Shaman Enterprises (shamansilverstore.in) Privacy Policy contains the
        entire understanding, and supersedes all prior understandings, between
        you and Shaman Enterprises (shamansilverstore.in) concerning its subject
      ...
      <h2 className="text-l text-center font-bold">Disclaimer</h2>
      <p>
        Shaman Enterprises (shamansilverstore.in) is not responsible for any
        content, code or any other imprecision.
        <br />
        Shaman Enterprises (shamansilverstore.in) does not provide warranties or
        guarantees.
        <br />
        In no event shall Shaman Enterprises (shamansilverstore.in) be liable
        for any special, direct, indirect, consequential, or incidental damages
        or any damages whatsoever, whether in an action of contract, negligence
        or other tort, arising out of or in connection with the use of the
        Service or the contents of the Service. Shaman Enterprises
        (shamansilverstore.in) reserves the right to make additions, deletions,
        ...
        (shamansilverstore.in) exercises no editorial control over such content
        ...
        through or accessible via the Shaman Enterprises (shamansilverstore.in)
        Service. Without limiting the foregoing, Shaman Enterprises
        (shamansilverstore.in) specifically disclaims all warranties and
        representations in any content transmitted on or in connection with the
        Shaman Enterprises (shamansilverstore.in) Service or on sites that may
        appear as links on the Shaman Enterprises (shamansilverstore.in)
        Service, or in the products provided as a part of, or otherwise in
        connection with, the Shaman Enterprises (shamansilverstore.in) Service,
        including without limitation any warranties of merchantability, fitness
        for a particular purpose or non-infringement of third party rights. No
        oral advice or written information given by Shaman Enterprises
        (shamansilverstore.in) or any of its affiliates, employees, officers,
        ...
        limiting the foregoing, Shaman Enterprises (shamansilverstore.in) does
        not warrant that the Shaman Enterprises (shamansilverstore.in) Service
